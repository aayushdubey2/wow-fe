...
<div class="home h-screen">
    ...
    <div class="flex justify-around mx-20 text-left">
        <div class="mt-10 p-6 bg-white shadow-lg rounded-lg w-1/3 text-sm">
            <h2 class="text-2xl font-bold mb-6">New Car</h2>
            <form @submit.prevent="addVehicle" class="space-y-4">
                ...
                <div class="flex justify-between items-end">
                    ...
                    <div class="w-1/2">
                        ...
                        <input v-model="vehicleDetails.LicensePlateNumber" type="text" class="mt-1 p-2 w-full border rounded-md"
                            required>
                    </div>
                </div>
                ...
                <div class="flex justify-between items-end">
                    ...
                    <div class="w-1/2">
                        ...
                        <input v-model="vehicleDetails.OdometerReading" type="number" class="mt-1 p-2 w-full border rounded-md"
                            required>
                    </div>
                </div>
        ...
        <div class="mt-10 p-6 bg-white text-sm shadow-lg rounded-lg w-1/3">
            ...
            <h2 class="text-2xl font-bold my-6">Rental Class</h2>
            <form @submit.prevent="addClass" class="space-y-4">
                ...
                <div>
                    ...
                    <input v-model="rentalClassDetails.DailyRate" type="number" class="mt-1 p-2 w-full border rounded-md"
                        required>
                </div>
                ...
                <button type="submit" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-700">Add Rental
                    Class</button>
            </form>
        </div>
    </div>
