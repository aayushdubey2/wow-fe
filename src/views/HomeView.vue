...
export default {
    ...
    data() {
        return {
            ...
            items:
                [
                    { title: 'Rent a car!', id: 1, description: 'Rent a car, shift gears to adventure, and drive your vacation dreams into reality!' },
                    { title: 'View Bookings!', id: 2, description: 'View and manage your bookings effortlessly. Take control of your travel plans.' },
                    { title: 'Contact us!', id: 2, description: 'Have questions or need assistance? Reach out to our support team through our Contact Us page' }
                ]
        };
    },
    methods: {
