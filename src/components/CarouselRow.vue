  ...
  <div class="split-horizontal flex justify-around carousel">
    <router-link v-ripple v-if="items[0]" :to="items[0].route" @click="handleRouterLinkClick(items[1].id)"
      ...
      <div class="items-end mt-5" style="height: 50%;">
        ...
        <img v-if="items[0].id" :src="icons['purpleArrowIcon']" alt="" class="inline m-2">
      </div>
    </router-link>
    ...
    <router-link v-ripple v-if="items[1]" :to="items[1].route" @click="handleRouterLinkClick(items[1].id)"
      ...
      <div class="items-end mt-5" style="height: 50%;">
        ...
        <img v-if="items[1].id" :src="icons['redArrowIcon']" alt="" class="inline m-2">
      </div>
    </router-link>
    ...
    <router-link v-ripple v-if="items[2]" :to="items[2].route" @click="handleRouterLinkClick(items[1].id)"
      ...
      <div class="items-end mt-5" style="height: 50%;">
        ...
        <img v-if="items[2].id" :src="icons['aquaArrowIcon']" alt="" class="inline m-2">
      </div>
    </router-link>
...
.yield-card {
  ...
  /* background: linear-gradient(to right, #d1a3e2, #a2b9e6); */
}
...
.blowing-card {
  ...
  /* background: linear-gradient(to right, #a4d3e3, #5bb1bf); */
}
</style>
